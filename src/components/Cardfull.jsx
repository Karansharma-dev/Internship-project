...
function Cardfull() {
    return (
        <div className="hero-container flex flex-col sm:flex-row justify-center gap-10 p-10 md:p-20 w-full ">
            <div className="hero-image w-90 h-60 bg-cover rounded-xl overflow-hidden">
            ...
            <div className="hero-text flex flex-col gap-4 justify-between">
                <div className="hero-text-container w-full md:w-[500px]">
                    ...
                    <h1 className="font-bold text-2xl md:text-4xl py-1">A Practical Guide to Apple Search Ads</h1>
                    <p className="py-1">Why it's a channel worth exploring to grow to app</p>
                </div>
