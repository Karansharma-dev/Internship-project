...
const SwiperPost2 = [
  ...
  {
    img: './Posts/img-9.webp',
    title: 'Leveraging press and partnerships for user acquisition and credibility — Adam Allore, Wavve Boating',
    desc: 'Adam Allore reveals partnership and PR strategies on the Sub Club podcast.',
    userImage: './user-data/user-7.jpg',
    userName: 'David Barnard'
  },
  ]
  ...
  return (
    <>
      ...
      >
        <SwiperSlide>
          {SwiperPost1.map((post, index) => (
            <div key={index} className="card-container justify-center gap-10 w-[330px] md:w-[370px] h-[470px] border-2 rounded-xl overflow-hidden">
